...
function setPixelToWorldScale() {
    let wordlToPixelScale;
    if (window.innerWidth / window.innerHeight < WORLD_WIDTH/ WORLD_HEIGHT) {
        wordlToPixelScale = window.innerWidth/WORLD_WIDTH
    } else {
        wordlToPixelScale = window.innerHeight/WORLD_HEIGHT
    }
    wordElem.style.width = `${WORLD_WIDTH * wordlToPixelScale}px`
    wordElem.style.height = `${WORLD_HEIGHT * wordlToPixelScale}px`
}
